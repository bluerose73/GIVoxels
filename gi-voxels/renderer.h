...
private:
    ...
    GBuffer g_buffer_;
    Voxels voxels_;
    Shader direct_light_shader_, voxel_cone_tracing_shader_;
    glm::vec3 prev_light_pos_;

    void RenderDirectLight(Camera& camera);
    void RenderVoxelConeTracing(Camera& camera);
};
